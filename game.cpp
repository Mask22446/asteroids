	...
	********************************************************************************/
        for (int j = 0; j < bullets.size(); j++)
        {
            ...
            if (dist < bigRocks.at(i)->getSize())
            {
                ...
                // First medium rock made from the big rock
                ...
                /***********************************************
		 * Second medium rock made from the big rock
                 * here we are creating a new medium rock object
		***********************************************/
		...
		***************************************************/
                ...
                /**********************************************
		 * Small rock made from the big rock
    ...
    // Deleting the bullets that have been killed here
